...
function Lighting() {
  return (
    <>
      <ambientLight intensity={0.45} color={colors.navy[100]} />
      <directionalLight
        position={[4, 6, 4]}
        intensity={1.15}
        color={colors.white}
      ...
      />
      <directionalLight position={[-5, 2, -3]} intensity={0.35} color={colors.green[50]} />
    </>
  );
}
...
// each gently bobbing/auto-rotating when left alone. See
